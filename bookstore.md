...
<!-- Add master reference to jQuery library -->
...
<div id="myaccount_links_placeholder"></div></li><li class="has-dropdown" id="translations"><a href="#"><i class="fi-web medium"></i></a><ul class="dropdown">
            ...
            <picture>
				...
				</div><form action="https://bookstore.onlineweb.shop/index.aspx?pageid=13NNo" method="get"><input name="pageid" id="pageid" type="hidden" value="13NNo" /><input name="chainID" id="chainID" type="hidden" value="859370" /><div class="small-12 medium-6 large-6 columns fws_quick_search_container" id="QuickSearch" data-editor-type="search">
                        <label data-lang="true" class="search-label" for="txtQuickSearch">Search</label>
                        <input id="txtQuickSearch" type="text" name="txtQuickSearch" class="radius">
                        <input id="search_button" class="icon-search" type="submit" value="search...">
                 </div></form>
			</div>

<script type="text/javascript">
    var _category_item = '<li><a href="#">[CategoryName]</a></li>';
    var _category_header = '<button id="cat-btn" class="large-12 columns title-block dropdown show-for-small-only">Categories</button>                <nav id="category-nav" class="row show-for-medium-up" data-topbar="">                    <section class="top-bar-section"  data-editor-type="categories">                         <ul class="left">';
    var _category_footer = '</ul>                </section>    </nav>'; 
    var _category_item_w_children = '<li class="has-dropdown"><a href="#">[CategoryName]</a>                [subItemTemplate]';
    var _category_sub_item = '<li><a href="#">[CategoryName]</a></li>';
    var _category_sub_header = '<ul class="dropdown">';
    var _category_sub_footer = '</ul>    </li>'; 
    var _category_depth = 1;
</script>

<div id="ui_categories_container"></div></header><div id="main-content">
				<div class="row">
					<div class="large-12 small-12  columns" data-editor-type="slideshow">
						

<link id="fws_slideshow_flexslider_css" rel="stylesheet" href="https://d3l66gvjdr7rqw.cloudfront.net/javascripts/flexslider/flexslider_v13.css" type="text/css" media="screen" />


<div class="slider-wrapper theme-default">
<div id="slider" class="flexslider">
<ul class="slides">
<li><picture><source srcset="https://cdn.freewebstore.com/origin/859370/465a45c254014bebb978f4c514025bb4.jpeg?webp=1"  type="image/webp" /><img src="https://cdn.freewebstore.com/origin/859370/465a45c254014bebb978f4c514025bb4.jpeg"  width="1200" height="400" style="height: auto;" /></picture></li>
<li><picture><source srcset="https://cdn.freewebstore.com/origin/859370/b71ec56f88b745318aa2bf8a03898248.jpeg?webp=1"  type="image/webp" /><img src="https://cdn.freewebstore.com/origin/859370/b71ec56f88b745318aa2bf8a03898248.jpeg"  width="1200" height="400" style="height: auto;" /></picture></li>
<li><picture><source srcset="https://cdn.freewebstore.com/origin/859370/5ba58d2da79c403399af8293ba349649.jpeg?webp=1"  type="image/webp" /><img src="https://cdn.freewebstore.com/origin/859370/5ba58d2da79c403399af8293ba349649.jpeg"  width="1200" height="400" style="height: auto;" /></picture></li>
<li><picture><source srcset="https://cdn.freewebstore.com/origin/859370/6fc4fcb8ec1e4c28ad0f853111b326de.jpeg?webp=1"  type="image/webp" /><img src="https://cdn.freewebstore.com/origin/859370/6fc4fcb8ec1e4c28ad0f853111b326de.jpeg"  width="1200" height="400" style="height: auto;" /></picture></li>
</ul>
</div>
<script type="text/javascript">
$(document).ready(function () {
$('#slider').flexslider({useCSS:true, touch:true, animation: 'fade', animationSpeed: 1200, slideshowSpeed: 7000, startAt: 0, directionNav: true, prevText: '<', nextText: '>', controlNav: false, pauseOnHover: true,  randomize: false});
});
</script>
...
<li>
                        ...
                        <div class="product-promo">
                             <span class="overlay_gfx">New</span>
                                <a href='https://bookstore.onlineweb.shop/Computer_Knowledge_for_SBI_IBPS_Clerk_PO_RRB_RBI_SSC_Insurance_Exams_2nd_Edition__Theory_Previous_Year___Practice_Questions_Computer_Awaren/p1i4WT_21990134.aspx' >
                                    <picture>
                                        <source srcset="https://cdn.freewebstore.com/resize/859370/screenshot_20221221_170051.png/192/259/0/?bg=ffffff&webp=1" type="image/webp" />
